...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('favorites', models.ManyToManyField(blank=True, to='first_app.restaurant')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dishes', models.ManyToManyField(blank=True, through='first_app.OrderItem', to='first_app.dish')),
                ('restaurant', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='first_app.restaurant')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='first_app.user')),
            ],
        ),
